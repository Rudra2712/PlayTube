...
import { deleteVideo } from "../../app/Slices/videoSlice";

function DeleteVideo({ videoId, onClose }) {
    ...
    <div className="fixed inset-0 top-[calc(66px)] z-10 flex flex-col bg-black/50 px-4 pb-[86px] pt-4 sm:top-[calc(82px)] sm:px-14 sm:py-8">
      <div className="mx-auto w-full max-w-lg overflow-auto rounded-lg border border-gray-700 bg-[#121212] p-4">
        <div className="mb-6 flex items-start gap-4">
          ...
          <button onClick={onClose} className="ml-auto h-6 w-6 shrink-0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button
            ...
            disabled={loading}
            className="col-span-2 bg-red-700 px-4 py-3 text-white hover:bg-red-800 disabled:opacity-50 sm:col-span-1"
          >
